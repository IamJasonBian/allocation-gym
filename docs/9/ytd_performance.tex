...
IWN put round-trips     & \textcolor{gain}{+\$3,250} \\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{../7/iwn_iv_smile.png}
  \caption{IWN implied volatility smile: early March vs late March 2026.
