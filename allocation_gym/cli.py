"""CLI entry point for allocation-gym."""

import argparse


def main():
    parser = argparse.ArgumentParser(description="allocation-gym: hardware scalping toolkit")
    ...
    print(f"allocation-gym: {args.command} — not yet implemented")
